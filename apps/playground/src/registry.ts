...
import { Card, Flex, MediaCaption, MediaCarousel, Overlay, Typography } from '@lce/layout';
 ...
 */
export const registry: ComponentRegistry = { Flex, Card, Overlay, Typography, MediaCaption, MediaCarousel };
